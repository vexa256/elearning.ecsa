...
<div class="offcanvas offcanvas-end border-0" tabindex="-1"
    id="theme-settings-offcanvas d-none">
    <div
    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <div class="p-4">
                ...
                <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Color Scheme
                </h6>
                ...
                <div id="sidebar-size">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Small (Icon
                                View)</h5>
                        </div>
                ...
                <div id="sidebar-view">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Sidebar
                        View</h6>
                    <p class="text-muted">Choose Default or Detached Sidebar
                        view.</p>
