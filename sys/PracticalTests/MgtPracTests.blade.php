    ...
    <div class="col-md-12">
        ...
        <div class="card-body pt-3 bg-light shadow-lg table-responsive">
            {!! Alert(
                $icon = 'fa-info',
                $class = 'alert-primary',
                $Title = $CourseName . ' Practical-Test',
                $Msg = 'Manage all Practical-Tests attached to the selected course',
            ) !!}
        ...
        <div class="card-body pt-3 bg-light shadow-lg table-responsive">
            ...
            {{ HeaderBtn($Toggle = 'New', $Class = 'btn-danger', $Label = 'New Practical-Test ', $Icon = 'fa-plus') }}
            ...
            <table
                ...
                <tbody>
                    @isset($PracticalTests)
                        @foreach ($PracticalTests as $data)
                            <tr>
...
@include('PracticalTests.NewPracTests')
